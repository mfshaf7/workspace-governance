...
An admitted entrant still requires a separate, reviewed active-inventory
promotion before it appears in the canonical repository, product, or component
...
- [docs/prototype-closure.md](docs/prototype-closure.md)
- [contracts/prototype-closure.yaml](contracts/prototype-closure.yaml)
...
- it governs intake classification before work quietly becomes active through
  the versioned [Workspace Intake](docs/workspace-intake.md) contract
