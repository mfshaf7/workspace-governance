...
REQUIRED_FILES = (
    ...
    "docs/pull-request-review-and-automation.md",
    "docs/governed-intake-assist.md",
    "docs/workspace-intake.md",
    "docs/workspace-active-inventory.md",
    ...
    "contracts/agent-source-implementation.yaml",
    "contracts/repository-custody.yaml",
    ...
    "contracts/schemas/workspace-inventory-lifecycle-mutation.schema.json",
    "contracts/schemas/workspace-inventory-lifecycle-readback.schema.json",
    "contracts/schemas/workspace-inventory-lifecycle-receipt.schema.json",
    ...
    "contracts/fixtures/workspace-intake/temporal-v1-entry.json",
    "contracts/schemas/intake-ai-suggestion-artifact.schema.json",
    "contracts/schemas/intake-ai-suggestion-candidate.schema.json",
    "contracts/schemas/intake-ai-suggestion.schema.json",
    "contracts/schemas/governed-intake-assist.schema.json",
    ...
    "contracts/schemas/agent-action-authority.schema.json",
    "contracts/schemas/agent-source-implementation.schema.json",
    ...
    "contracts/schemas/repository-custody.schema.json",
    "contracts/schemas/repository-custody-request.schema.json",
    "contracts/schemas/repository-custody-decision.schema.json",
    "contracts/schemas/repository-provider-readback.schema.json",
    "contracts/schemas/repository-custody-receipt.schema.json",
    ...
    "contracts/schemas/governance-validator-catalog.schema.json",
    "contracts/schemas/delivery-art-operator-path.schema.json",
    ...
    "contracts/fixtures/repository-custody/request.valid.json",
    "contracts/fixtures/repository-custody/decision.valid.json",
    "contracts/fixtures/repository-custody/provider-readback.valid.json",
    "contracts/fixtures/repository-custody/receipt.valid.json",
    "generated/README.md",
    "docs/delegated-execution.md",
    "docs/agent-action-authority.md",
    "docs/repository-custody.md",
    "tests/test_agent_action_authority.py",
    "tests/test_agent_source_implementation.py",
    "tests/test_repository_custody.py",
    "reviews/README.md",
    ...
    "scripts/repository_custody_contract.py",
    "scripts/check_remote_alignment.py",
    "scripts/install_skills.py",
    "scripts/governed_intake_assist.py",
    "scripts/scaffold_intake.py",
    "scripts/workspace_intake.py",
    ...
    "tests/test_governed_intake_assist.py",
