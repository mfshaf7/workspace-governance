...
CONTRACT_FILES = {
    ...
    "project_lifecycle_proof": "contracts/project-lifecycle-proof.yaml",
    "prototype_landing": "contracts/prototype-landing.yaml",
    "prototype_maturity": "contracts/prototype-maturity.yaml",
    "prototype_closure": "contracts/prototype-closure.yaml",
    "workspace_intake": "contracts/workspace-intake.yaml",
    "workspace_active_inventory": "contracts/workspace-active-inventory.yaml",
    "workspace_inventory_lifecycle": "contracts/workspace-inventory-lifecycle.yaml",
    "workspace_inventory_history": "contracts/workspace-inventory-history.yaml",
    ...
    "durable_orchestration": "contracts/durable-orchestration.yaml",
    "delegation_policy": "contracts/delegation-policy.yaml",
    "agent_action_authority": "contracts/agent-action-authority.yaml",
    "agent_source_implementation": "contracts/agent-source-implementation.yaml",
    "agent_action_conformance": "contracts/agent-action-conformance.yaml",
...
SCHEMA_FILES = {
    ...
    "project_lifecycle_proof": "contracts/schemas/project-lifecycle-proof.schema.json",
    "prototype_landing": "contracts/schemas/prototype-landing.schema.json",
    "prototype_maturity": "contracts/schemas/prototype-maturity.schema.json",
    "prototype_closure": "contracts/schemas/prototype-closure.schema.json",
    "workspace_intake": "contracts/schemas/workspace-intake.schema.json",
    "workspace_active_inventory": "contracts/schemas/workspace-active-inventory.schema.json",
    "workspace_inventory_lifecycle": "contracts/schemas/workspace-inventory-lifecycle.schema.json",
    "workspace_inventory_history": "contracts/schemas/workspace-inventory-history.schema.json",
    ...
    "durable_orchestration": "contracts/schemas/durable-orchestration.schema.json",
    "delegation_policy": "contracts/schemas/delegation-policy.schema.json",
    "agent_action_authority": "contracts/schemas/agent-action-authority.schema.json",
    "agent_source_implementation": "contracts/schemas/agent-source-implementation.schema.json",
    "agent_action_conformance": "contracts/schemas/agent-action-conformance.schema.json",
    "repository_custody": "contracts/schemas/repository-custody.schema.json",
